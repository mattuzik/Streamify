...
import { setFilters } from '../../entities/movie/model/slice';
import { useGetFilmsBySearchQuery } from '../../entities/movie/api/services';
...
const Search = () => {
  ...
  const { keyword } = useSelector((state: any) => state.movies);
